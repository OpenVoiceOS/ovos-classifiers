...
from ovos_classifiers.datasets import get_coref_iob_tagged_sents
...
corpus = get_coref_iob_tagged_sents()
...
# train tagger
clf = OVOSNgramTagger(default_tag="O")
...
# train brill
clf = OVOSBrillTagger(default_tag="O")
clf.train(train_data)
