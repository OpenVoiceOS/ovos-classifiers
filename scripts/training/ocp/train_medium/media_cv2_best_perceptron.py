...
csv_small_path = f"{dirname(dirname(__file__))}/datasets/ocp_media_types_balanced_small_v0.csv"
csv_path = f"{dirname(dirname(__file__))}/datasets/ocp_media_types_v0.csv"
csv_big_path = f"{dirname(dirname(__file__))}/datasets/ocp_media_types_balanced_big_v0.csv"

ents_csv_path = f"{dirname(dirname(__file__))}/datasets/ocp_entities_v0.csv"

clf_id = "media_ocp_cv2_medium"
retrain = False
pipelines = [
    "cv2",
    "cv2_lemma",
...
def find_best_pipeline_perceptron():
    global pipelines
    mkdown_table = """
...
find_best_hyperparams_perceptron("cv2")  # tiny
find_best_hyperparams_perceptron("cv2_lemma")  # tiny
find_best_hyperparams_perceptron("skipgram2")  # tiny
